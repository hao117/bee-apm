...
public class KafkaTransmitter extends AbstractTransmitter {
    ...
    @Override
    public int init() {
        topicMap = (Map<String, String>) ConfigUtils.me().getVal("transmitter.kafka1x.topic");
    ...
    private void initKafkaConfig(){
        try {
            ...
            Map<String, Object> configMap = (Map<String, Object>) ConfigUtils.me().getVal("transmitter.kafka1x.kafkaConfig");
